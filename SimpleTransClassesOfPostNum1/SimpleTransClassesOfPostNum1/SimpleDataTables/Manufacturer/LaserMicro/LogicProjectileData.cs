...
public class LogicProjectileData(CsvRow row, LogicDataTable table) : LogicData(row, table)
{
    ...
    private int _consumableShield;
    private int _consumableShieldTicks;
    private int _damageChangeEndPromille;
    ...
    public override void CreateReferences()
    {
        ...
        _damageChangeEndPromille = GetIntegerValue("DamageChangeEndPromille", 0);
        ...
        _consumableShield = GetIntegerValue("ConsumableShield", 0);
        _consumableShieldTicks = GetIntegerValue("ConsumableShieldTicks", 0);
    }
    ...
    public int GetConsumableShield()
    {
        return _consumableShield;
    }

    public int GetConsumableShieldTicks()
    {
        return _consumableShieldTicks;
    }
    ...
    public int GetDamageChangeEndPromille()
    {
        return _damageChangeEndPromille;
    }
